...
/**
 * Parse DNAnexus information on tools and projects
 * into the Vuex store format.
 * 
 * @param {boolean} allProjects Gather information on all projects,
 *                  not just St. Jude Cloud projects.
 * @param {boolean} allFiles Gather information on all files, not
 *                  just St. Jude Cloud results files.
 * @param {callback} callback
 */
